...
const metodeIsiTanggalKeluar = ref<"sekarang" | "manual">("sekarang");
...
async function onSubmit() {
  ...
  try {
    await backendFetch(
      pengeluaranCrudChannelNames.ADD,
      Object.assign(
        {},
        {
    ...
    $toast.success("Berhasil tambah data pengeluaran");
    emits("submit");
  } catch (error: any) {
...
<template>
  <v-card title="Buat Pengeluaran Baru">
    <v-card-subtitle>
